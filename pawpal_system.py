...
class Scheduler:
    ...
    def detect_conflicts(self, tasks: List[Tuple[str, Task]]) -> List[str]:
        ...
        (see reflection.md section 2b for the tradeoff reasoning).
        ...
        Returns:
            ...
            Example: "Conflict at 2026-03-18 08:30 - Buddy: Morning brush, Luna: Litter box cleaning"
        """
        seen: dict = {}  # key: (due_date, due_time) -> list of "pet: description"
